...
(function() {
    ...
    function Za(h, p, D) {
        ...
        if (isNaN(u)) {
            try {
                h = "position:relative; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + h + "; font-size:" + p + "px; font-weight:" + D + ";";
                if (!xa) {
                    var H = document.body;
    ...
    Na.Chart = function() {
        ...
        function p(a, d) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                this._canvasJSContainer.style.padding = "40px";
